            ...
            <div className='about'>
                ...
                <div className='c2'>
                    <div className='c2in'>
                        ...
                        <img src={"https://cristianonew.ukrdevs.com/wp-content/uploads/2018/04/news-1-675x439.jpg"} alt='about' />
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                <br /><br />
                                All food portions catered and delivered by Makan Mate are described as generous. We make sure that we serve more than enough to make you and your guests pleased and satisfied.</p>
                        </div>
                    </div>

                    <div className='c2in'>

                        <img src={"https://cristianonew.ukrdevs.com/wp-content/uploads/2016/08/restaurant-675x450.jpg"} alt='about' />
                    ...
                    <div className='c2in'>
                        <img src={"https://cristianonew.ukrdevs.com/wp-content/uploads/2016/08/bar-2-675x450.jpg"} alt='about' />
                        <div>
                            <h1>Engage our Food Catering Services</h1>
                            <p>
                                Worry no more about preparing or cooking food in your parties and events! Entrust the job to Makan Mate and enjoy your day with ease and peace of mind. Contact us today at (65) 6264 2233 ext 16-21 to discuss your catering preferences and we’ll be happy to explain our catering offers and packages.</p>
                        </div>
                    </div>
                </div>
